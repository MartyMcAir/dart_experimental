...
// методы context.watch(), context.read(), и context.select() могут использоваться как в концепции flutter_bloc, так и в концепции Provider. Эти методы являются частью библиотеки provider и предоставляют гибкий способ работы с состоянием в различных архитектурных подходах.
