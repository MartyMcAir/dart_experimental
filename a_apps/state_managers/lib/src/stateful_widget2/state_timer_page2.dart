...
class StateTimerPage2 extends StatefulWidget {
  final int waitTimeInSec;

  const StateTimerPage2({Key? key, required this.waitTimeInSec})
      : super(key: key);

  @override
  _StateTimerPage2State createState() => _StateTimerPage2State();
}

class _StateTimerPage2State extends State<StateTimerPage2> {
  Timer? _timer;
  late int _waitTime;
  var _percent = 1.0;
  var isStart = false;
